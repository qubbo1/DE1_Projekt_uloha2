## =============================================================================
## nexys_a7_50t.xdc
## Constraints pre Nexys A7-50T – Generátor priebehov
## =============================================================================

## -----------------------------------------------------------------------
## Hodinový signál – 100 MHz
## -----------------------------------------------------------------------
...
## -----------------------------------------------------------------------
## 7-segmentový displej – katódy (aktívne LOW)
...
## 7-segmentový displej – anódy (aktívne LOW)
...
## -----------------------------------------------------------------------
## Pmod JA – PWM výstup
## JA(0) = JA pin 1 → hlavný PWM výstup (RC filter → analógový signál)
## -----------------------------------------------------------------------
set_property -dict { PACKAGE_PIN C17 IOSTANDARD LVCMOS33 } [get_ports { JA[0] }]  ;# JA1 – PWM OUT
