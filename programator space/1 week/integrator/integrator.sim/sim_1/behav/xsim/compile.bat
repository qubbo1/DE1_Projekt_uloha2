...
REM
REM Generated by Vivado on Wed Apr 08 17:02:01 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_integrator_vhdl.prj"
call xvhdl  --incr --relax -prj tb_integrator_vhdl.prj -log xvhdl.log
